Feature: placing order and register before checkout
  As a user, I want to register before checkout and place an order
  Background:
    Given I am on Homepage
    @SMoke
Scenario: place order and register before checkout
When I Click on Signup or Login Button
  And I Enter "xyz" and "AD2@gmail.com" address
...
@Pinal3
  Scenario: verify address details in checkout page
    When I Click on Signup or Login Button
    And I Enter "xyz" and "yab@gmail.com" address
    And I Click Signup button
    And I should  that ENTER ACCOUNT INFORMATION is visible
    And I select title
    And I enter password "abc123"
